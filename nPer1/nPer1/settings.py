"""
Django settings for nPer1 project.
...
SECRET_KEY = 'django-insecure-jordf**vhd4+dsp0fal1bw+wy9+*6%9of(58&$o!=#8hj!7(^c'
...
WSGI_APPLICATION = 'nPer1.wsgi.application'
