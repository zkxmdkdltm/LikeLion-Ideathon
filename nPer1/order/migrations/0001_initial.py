# Generated by Django 4.0.4 on 2022-06-29 10:30
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('foodCategory', models.CharField(choices=[('돈까스·회·일식', '돈까스·회·일식'), ('고기·구이', '고기·구이'), ('패스트푸드', '패스트푸드'), ('카페·디저트', '카페·디저트'), ('치킨', '치킨'), ('중식', '중식'), ('피자', '피자'), ('양식', '양식'), ('백반·죽·국수', '백반·죽·국수'), ('찜·찌개·탕', '찜·찌개·탕'), ('분식', '분식'), ('족발·보쌈', '족발·보쌈')], max_length=20)),
