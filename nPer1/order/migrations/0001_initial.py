<<<<<<< HEAD
# Generated by Django 4.0.3 on 2022-06-30 04:42
=======
# Generated by Django 4.0.5 on 2022-06-30 04:47
>>>>>>> 729a1ca22244ca40a7ab78959ecd8694035f14ab
...
<<<<<<< HEAD
                ('foodCategory', models.CharField(choices=[('피자', '피자'), ('돈까스·회·일식', '돈까스·회·일식'), ('백반·죽·국수', '백반·죽·국수'), ('분식', '분식'), ('중식', '중식'), ('양식', '양식'), ('치킨', '치킨'), ('족발·보쌈', '족발·보쌈'), ('카페·디저트', '카페·디저트'), ('찜·찌개·탕', '찜·찌개·탕'), ('패스트푸드', '패스트푸드'), ('고기·구이', '고기·구이')], max_length=20)),
=======
...
<<<<<<< HEAD
                ('host_option', models.CharField(choices=[('count', 'count'), ('time', 'time'), ('button', 'button')], max_length=10)),
                ('option_num', models.IntegerField(null=True)),
                ('pay_option', models.BooleanField(default=True)),
                ('create_at', models.DateTimeField(auto_now=True)),
                ('state', models.CharField(choices=[('결제전', '결제전'), ('주문완료', '주문완료'), ('주문중', '주문중')], default='결제전', max_length=10)),
=======
