    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('foodCategory', models.CharField(choices=[('양식', '양식'), ('피자', '피자'), ('카페·디저트', '카페·디저트'), ('고기·구이', '고기·구이'), ('돈까스·회·일식', '돈까스·회·일식'), ('치킨', '치킨'), ('패스트푸드', '패스트푸드'), ('백반·죽·국수', '백반·죽·국수'), ('족발·보쌈', '족발·보쌈'), ('분식', '분식'), ('중식', '중식'), ('찜·찌개·탕', '찜·찌개·탕')], max_length=20)),
