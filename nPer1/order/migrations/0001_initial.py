    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('foodCategory', models.CharField(choices=[('백반·죽·국수', '백반·죽·국수'), ('찜·찌개·탕', '찜·찌개·탕'), ('양식', '양식'), ('족발·보쌈', '족발·보쌈'), ('치킨', '치킨'), ('카페·디저트', '카페·디저트'), ('피자', '피자'), ('고기·구이', '고기·구이'), ('분식', '분식'), ('중식', '중식'), ('패스트푸드', '패스트푸드'), ('돈까스·회·일식', '돈까스·회·일식')], max_length=20)),
